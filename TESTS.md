...
**Планируется:** [v0.27](ROADMAP.md#v027--анимации-фона-20) анимации фона · [v0.23](ROADMAP.md#v023--мобильное-приложение) мобилка
...
| 7.2b1 | **Backlog v0.27:** уровни `subtle` / `auto` / `intense` — `intense` заметно посильнее | [ ] |
